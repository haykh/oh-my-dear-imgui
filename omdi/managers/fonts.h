...
namespace omdi {
  ...
  /**
   * @brief Font manager for handling multiple fonts and sizes in ImGui.
   */
  class FontManager {
    std::map<std::string, std::map<omdi::fonts::Size, ImFont*>> m_fonts;
    std::map<std::string, std::map<omdi::fonts::Size, ImFont*>> m_icons;

    std::vector<std::string> m_font_list;

    int               m_active_font_idx { -1 };
    std::string       m_active_font { "" };
    omdi::fonts::Size m_active_font_size { omdi::fonts::Size::None };

  public:
    std::vector<omdi::fonts::Size> SIZES = { omdi::fonts::Small,
                                             omdi::fonts::Normal,
                                             omdi::fonts::Medium,
                                             omdi::fonts::Large,
                                             omdi::fonts::Huge };
    ...
    [[nodiscard]]
    auto font(const std::string&, omdi::fonts::Size) -> ImFont*;

    [[nodiscard]]
    auto icon(const std::string&, omdi::fonts::Size) -> ImFont*;
    ...
    [[nodiscard]]
    auto active_font_size() const -> omdi::fonts::Size {
