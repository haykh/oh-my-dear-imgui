...
#define HEATMAP_FRAGMENT_SHADER_CODE                                           \
  ...
  "}\n"
    ...
    static void CompileShader(HeatmapShader& ShaderProgram,
      ...
      ShaderProgram.AttribLocationProjection = glGetUniformLocation(
        ShaderProgram.ID,
        "ProjMtx");
      ...
      ShaderProgram.AttribLocationMaxValue = glGetUniformLocation(ShaderProgram.ID,
                                                                  "max_val");
      ShaderProgram.AttribLocationMinBounds = glGetUniformLocation(
        ShaderProgram.ID,
        "bounds_min");
      ShaderProgram.AttribLocationMaxBounds = glGetUniformLocation(
        ShaderProgram.ID,
        "bounds_max");
    ...
    static void CreateHeatmapShader(const ImDrawList*, const ImDrawCmd*) {
      ContextData& Context = *(
        (ContextData*)omdi::implot::GImPlotWrapper->backendCtx);
